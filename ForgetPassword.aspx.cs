...
public partial class Faculty_ForgetPassword : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from Faculty_Registration where Email='" + TextBox1.Text + "'", con);
